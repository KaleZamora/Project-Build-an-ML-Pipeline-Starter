...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = 'Only god can help you now',
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "No seriously whats happening",
        required = True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type = str,
        help = "Help i am trapped in a computer",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "Check out Magnus Archives",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help = "No seriously its really good",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help = "Also check out Malevolent",
        required = True
    )
